...
def favorite_color(favorite_list)
  ...
  favorite_list[:color]
  # fetch did not work here because it returns an error and not nil
...
def favorite_number(favorite_list)
  ...
  # remember that fetch can take two arguments (one that has been passed in and then a default option if nothing is passed in through symbol)
